...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            headerToolbar: {
                left: 'today', // Remove buttons from the left
                center: 'title', // Center the calendar title (month and year)
                right: 'prev,next' // Move "Previous," "Next," and "Today" buttons to the right
            }
        });
        calendar.render();
    });
