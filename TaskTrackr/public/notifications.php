...
<div class="d-flex">
    ...
    <main class="main-content flex-grow-1 p-4">
        <div class="container-fluid px-0">
            <h2 class="mb-4 fw-bold text-center" style="color: #ffffff"><i class="bi bi-bell me-2" style="color: #ffffff"></i>Notifications</h2>

            <!-- Alerts -->
            <?php include('../includes/alerts.php'); ?>

            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap" >
                <p class="mb-2 mb-md-0" style="color: #ffffff;">
            ...
            <?php if ($notifications->num_rows === 0): ?>
                <div class="d-flex flex-column align-items-center justify-content-center p-5 text-center text-muted">
                    ...
                    <p class="mt-3 mb-0" style="color: #ffffff">You have no notifications.</p>
                </div>
            <?php else: ?>
                <div class="row g-3">
                    <?php while ($notification = $notifications->fetch_assoc()): ?>
                        <div class="col-12">
                            <div class="card shadow-sm p-3 d-flex flex-row align-items-center justify-content-between
                                <?= !$notification['is_read'] ? 'border-primary bg-dark' : 'border-0' ?>"
