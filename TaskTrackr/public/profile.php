...
<div class="d-flex">
    ...
    <main class="main-content flex-grow-1 p-4">
        <div class="container-fluid px-0">
            <h2 class="mb-4 fw-bold" style="color: #ffffff"><i class="bi bi-person-circle me-2" style="color: #ffffff"></i>My Profile</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-blue">
                            <h5 class="mb-0"style="color: #ffffff"><i class="bi bi-lock me-2" style="color: #ffffff"></i>Change Password</h5>
                        </div>
                        <div class="card-body">
