    ...
    <main class="main-content flex-grow-1 p-4">
        <div class="container-fluid px-0">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4" >
                <h2 class="fw-bold mb-0" style = "color: #ffffff"><i class="bi bi-folder me-2" style = "color: #ffffff"></i>Your Projects</h2>
                <button class="btn btn-primary d-flex align-items-center" style="background-color: #27223e; border-color: #27223e;" data-bs-toggle="modal" data-bs-target="#addProjectModal">
