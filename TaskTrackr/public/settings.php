...
<div class="d-flex">
    ...
    <main class="main-content flex-grow-1 p-4">
        <div class="container-fluid px-0">
            <h2 class="mb-4 fw-bold" style="color: #ffffff"><i class="bi bi-gear me-2" style="color:#ffffff"></i>Settings</h2>
                ...
                <div class="col-lg-7 col-md-10">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-light d-flex align-items-center">
                            <i class="bi bi-bell me-2" style="color:#0a061e"></i>
                            <h5 class="mb-0" style="color:#0a061e">Task Reminder</h5>
                        </div>
                        <div class="card-body">
