    ...
    <main class="main-content flex-grow-1 p-4">
        <div class="container-fluid px-0">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
                <h2 class="fw-bold mb-0 " style = "color: #ffffff"><i class="bi bi-list-task me-2"style = "color: #ffffff"></i>Your Assigned Tasks</h2>
            </div>
            ...
            <?php if (empty($tasks_by_project)): ?>
                <div class="d-flex flex-column align-items-center justify-content-center p-5 text-center text-muted">
                    <i class="bi bi-clipboard-x" style="font-size: 2.5rem; color: #ffffff"></i>
                    <p class="mt-3 mb-0" style = "color: #ffffff">No tasks assigned to you yet.</p>
                </div>
            <?php else: ?>
